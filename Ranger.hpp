...
#ifndef PROJECT_2_RANGER_CLASS_
#define PROJECT_2_RANGER_CLASS_
...
public:  
    ...
    */
    Ranger(const std::string& name, const std::string& race, int vitality = 0, int armor = 0,
        int level = 0, bool enemy = false, vector<Arrows> arrows = {}, vector<std::string> affinities = {},
    ...
    **/
    bool addArrows(const std::string& arrow, const int& quantity);
